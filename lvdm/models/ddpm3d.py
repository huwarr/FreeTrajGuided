...
class LatentDiffusion(DDPM):
    ...
    def apply_model(self, x_noisy, t, cond, return_cross_attn=False, return_self_attn=False, **kwargs):
        ...
        x_recon = self.model(x_noisy, t, **cond, return_cross_attn=return_cross_attn, return_self_attn=return_self_attn, **kwargs)
